...
const privateActionsCreators = {
  ...
  modifyNoteSuccess: payload => ({ type: actions.MODIFY_NOTE_SUCCESS, payload, target: 'modifyNote' }),
  modifyNoteFailure: () => ({ type: actions.MODIFY_NOTE_FAILURE, target: 'modifyNote' }),
